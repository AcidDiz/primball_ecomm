<template>
  <div
    class="modal fade fixed top-40 left-0  hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    :id="id"
    tabindex="-1"
    ...
    role="dialog"
  >
    <div class="modal-dialog relative w-auto pointer-events-none" :class="modalSizeClass">
      <div
